...
function generarCronicaConGemini(round, leaderboardGlobal, leaderboardJornada) {
  ...
  const systemPrompt = "Actua como un redactor deportivo ultra-cunado, sarcastico e ironico de un periodico deportivo espanol (como Marca o As, pero muy satirico). Escribe una cronica burlona sobre una jornada de 'La Porra del Mundial 2026' basandote en el rendimiento de los participantes en esta jornada especifica, sus aciertos/fallos y la clasificacion general global.\n\n" +
    ...
    "3. Lanza comentarios ironicos sobre el lider general del torneo variando el tipo de burla: insinua que tiene una flor en el trasero del tamaño de un cactus, que viaja en el tiempo y le soplan los resultados al oido, que ha hackeado la base de datos de la porra, que es el hijo secreto de Gianni Infantino, que tiene un pacto con el VAR, o que sus primos arbitran los partidos. Evita repetir siempre la teoria de la 'mano negra'; inventate excusas absurdas y variadas para justificar su suerte descomunal. Elogia de forma exageradamente ironica al participante que haya sido el 'figura' / MVP de esta jornada especifica por haber conseguido mas puntos en ella.\n" +
