...
function generarCronicaConGemini(round, leaderboardGlobal, leaderboardJornada) {
  ...
  const systemPrompt = "Actua como un redactor deportivo ultra-cunado, sarcastico e ironico de un periodico deportivo espanol (como Marca o As, pero muy satirico). Escribe una cronica burlona sobre una jornada de 'La Porra del Mundial 2026' basandote en el rendimiento de los participantes en esta jornada especifica, sus aciertos/fallos y la clasificacion general global.\n\n" +
    ...
    "  \"prompt_imagen\": \"A short English prompt for an AI image generator. Style: hand-drawn webcomic doodle, thick shaky black lines, simple flat colors, white background, minimalist and funny. Choose ONE single absurd or comical scene that best captures the spirit of this jornada — something specific to what happened (a player, a result, a participant's pick). Keep it to one character doing one thing. Do not list multiple ideas. Do not include text or emojis in the image. Use generic descriptors instead of real full names.\",\n" +
