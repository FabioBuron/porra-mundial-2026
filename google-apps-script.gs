...
function generarCronicaConGemini(round, leaderboardGlobal, leaderboardJornada) {
  ...
  const systemPrompt = "Actua como un redactor deportivo ultra-cunado, sarcastico e ironico de un periodico deportivo espanol (como Marca o As, pero muy satirico). Escribe una cronica burlona sobre una jornada de 'La Porra del Mundial 2026' basandote en el rendimiento de los participantes en esta jornada especifica, sus aciertos/fallos y la clasificacion general global.\n\n" +
    ...
    "  \"prompt_imagen\": \"A detailed English prompt for an AI image generator. The image MUST be in the style of 'Garabatos Random' webcomic / doodles: simple, funny, hand-drawn illustration with thick shaky black lines, minimalist raw caricature drawing, very simple and basic coloring with flat colors, blank or solid light background. It MUST represent a highly literal, absurd, and comical visualization of the funny metaphors or situations described in the chronicle. DO NOT create a generic or normal soccer scene. Think of something extremely surreal and weird. For example: if a player is said to have 'a flower in their butt', describe a soccer player running on the field with a giant comical flower blooming out of their shorts. If they chose 'nobody' as a scorer, describe an empty soccer uniform floating and kicking a ball. If a goalie has 'holes in their hands', describe a panicked goalkeeper staring at giant holes in their palms as a ball flies through. Make it weird, extremely silly, and cartoonish. Do not include emojis or text in the image. Keep it safe and generic (no real names or specific real-life people to avoid safety filters).\",\n" +
